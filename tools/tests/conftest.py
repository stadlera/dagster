"""Tools integration fixture using the public ingest runtime APIs."""
...
class Workspace:
    ...
    def statuses(self) -> dict[str, str]:
        ...
        return {path.replace(f"{self.remote}/", ""): status.value for path, status in rows}
...
def ws(tmp_path) -> Workspace:
    ...
    (remote / "em.csv").write_bytes(CSV_09)
